...
public class yuns_bankMethod {
	...
	public static String id[] = new String[100]; // 회원 아이디
	public static int[] pw = new int[100]; // 회원 비밀번호 
	public static int[] save = new int[100]; // 회원 통장
	public static String idID = null;
	public static int pwPW = 0;
	public static int addList = 1; // 계정추가를 위해 필요한 코드 관리자는 0번 인덱스 고정 고로 1부터 시작
